		...
		<section class="service-detail-2">
			<div class="container">
				<div class="head-title">
					<h2>
						<xsl:value-of disable-output-escaping="yes" select="/NewsDetail/RelatedServiceText">
						</xsl:value-of>
					</h2>
				</div>
		...
		<div class="swiper-slide">
			<div class="wrapper">
				...
				<a class="btn-view">
					...
					<span>
						<xsl:value-of disable-output-escaping="yes" select="/NewsDetail/LearnModeText"></xsl:value-of>
					</span>
				</a>
			</div>
		</div>
